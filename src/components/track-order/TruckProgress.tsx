...
const TruckProgress: FC<TruckProgressProps> = ({
  ...
  const lightBrown = '#B27D7D';

  const rearWheelCenter = '402.096px 376.06px';
  const frontWheelCenter = '90.868px 376.06px';
  ...
  }, [progressPercentage, wheelControls, bodyControls, animationDuration]);
  ...
  return (
    ...
    >
      <motion.svg
        viewBox="0 0 512 512"
        className="h-14 w-18 drop-shadow-lg"
        variants={engineIdleVariants}
        animate={bodyControls}
        initial="idle"
      >
        <defs>
          <linearGradient id="rocketGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={sections[currentIndex].iconColor} />
            <stop offset="100%" stopColor={sections[currentIndex].iconColor} stopOpacity="0.8" />
          </linearGradient>
        </defs>
          ...
          <g>
            ...
            <g>
              <g>
                ...
                <g>
                  <rect height="263.713" style={{ fill: lightBrown }} width="19.757" x="3.025" y="81.837" />
                </g>
                <g>
                ...
                <g>
                  <path
                    d="M500.409,243.869V345.55h-14.336v-86.421c0-7.629-3.012-14.938-8.393-20.32l-76.017-76.057c-5.38-5.381-12.689-8.393-20.32-8.393h-33.371V139.1h47.667c7.629,0,14.938,3.012,20.32,8.392l76.017,76.057C497.357,228.931,500.409,236.24,500.409,243.869z"
                    style={{ fill: '#EDEDED' }}
                  />
                </g>
                <g>
                  <path
                    d="M476.32,247.811H367.742v-88.934h27.905c2.372,0,4.586,0.909,6.285,2.53l77.867,78.025C482.881,242.555,480.706,247.811,476.32,247.811z"
                    style={{ fill: '#7AD2FA' }}
                  />
                </g>
                <g>
                ...
                <g>
                  <path
                    d="M476.32,250.822H367.743c-1.663,0-3.012-1.349-3.012-3.012v-88.933c0-1.663,1.349-3.012,3.012-3.012h27.902c3.121,0,6.09,1.192,8.365,3.361l77.922,78.082c2.31,2.337,2.957,5.655,1.702,8.659C482.382,248.964,479.578,250.822,476.32,250.822z M370.755,244.799H476.32c1.149,0,1.612-0.808,1.757-1.153c0.145-0.353,0.4-1.263-0.42-2.094l-77.859-78.02c-1.094-1.039-2.588-1.643-4.153-1.643h-24.89V244.799z"
                    style={{ fill: '#333333' }}
                  />
                </g>
                <g>
                  <g>
                    <path
                      d="M500.378,284.447v30.096h-39.719c-2.43,0-4.439-1.963-4.439-4.44v-9.957c0-1.215,0.514-2.336,1.262-3.177c4.112-4.065,6.916-6.869,10.888-10.888c1.122-1.028,2.477-1.635,3.925-1.635L500.378,284.447L500.378,284.447z"
                      style={{ fill: '#FEE9B4' }}
                    />
                  </g>
                </g>
                ...
                <g>
                  <path
                    d="M30.414,376.07H10.657c-4.216,0-7.63-3.414-7.63-7.63v-22.89h19.757v22.889C22.784,372.656,26.197,376.07,30.414,376.07z"
                    style={{ fill: '#EDEDED' }}
                  />
                </g>
                <g>
                  <path
                    d="M508.991,353.18v15.259c0,4.217-3.413,7.63-7.629,7.63h-19.757c4.216,0,7.63-3.414,7.63-7.63V353.18c0-4.216-3.414-7.63-7.63-7.63h19.757C505.578,345.55,508.991,348.964,508.991,353.18z"
                    style={{ fill: '#A8B2B4' }}
                  />
                </g>
                ...
                <motion.g
                  ...
                  style={{ transformOrigin: rearWheelCenter }}
                >
                  <circle cx="402.096" cy="376.06" r="54.108" style={{ fill: '#A8B2B4' }} />
                  <path
                    d="M402.096,398.037c-12.12,0-21.98-9.857-21.98-21.976s9.86-21.976,21.98-21.976c12.112,0,21.972,9.857,21.972,21.976S414.209,398.037,402.096,398.037z"
                    style={{ fill: '#FFFFFF' }}
                  />
                </motion.g>
                ...
                <motion.g
                  variants={wheelVariants}
                  animate={wheelControls}
                  style={{ transformOrigin: frontWheelCenter }}
                >
                  <ellipse
                    cx="90.868"
                    cy="376.06"
                  ...
                  />
                  <path
                    d="M90.867,398.037c-12.112,0-21.973-9.857-21.973-21.976s9.861-21.976,21.973-21.976c12.12,0,21.98,9.857,21.98,21.976S102.987,398.037,90.867,398.037z"
                    style={{ fill: '#FFFFFF' }}
                  />
                </motion.g>
                ...
                <g>
                  <g>
                    <path
                      d="M456.22,376.058c0,29.882-24.257,54.141-54.139,54.141c-19.36,0-36.308-10.201-45.788-25.544c8.194,5.061,17.913,8.033,28.276,8.033c29.882,0,54.141-24.259,54.141-54.141c0-10.443-2.971-20.243-8.113-28.436C445.94,339.59,456.22,356.619,456.22,376.058z"
                      style={{ fill: '#7C8B8E' }}
                    />
                  </g>
                  <g>
                    <path
                      d="M145.016,376.058c0,29.882-24.259,54.141-54.141,54.141c-19.439,0-36.469-10.201-45.947-25.625c8.194,5.141,17.993,8.113,28.436,8.113c29.882,0,54.141-24.259,54.141-54.141c0-10.443-2.973-20.243-8.113-28.436C134.732,339.59,145.016,356.619,145.016,376.058z"
                      style={{ fill: '#7C8B8E' }}
                    />
                  </g>
                </g>
            ...
            <g>
              <path
                d="M392.644,270.532h-24.902c-1.663,0-3.012-1.349-3.012-3.012s1.349-3.012,3.012-3.012h24.902c1.663,0,3.012,1.349,3.012,3.012C395.657,269.183,394.308,270.532,392.644,270.532z"
                style={{ fill: '#333333' }}
              />
            </g>
          </g>
